<form wire:submit.prevent="save">
    <div class="form-group row">
        ...
        <div class="col-sm-9 col-md-10">
            <input type="text" class="form-control" id="input1" wire:model="taskTitle" required>
            @error('taskTitle')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9 col-md-10">
            <textarea class="form-control" id="input2" rows="3" wire:model="taskBody" required></textarea>
            @error('taskBody')
            <x-error-form :message="$message"/>
            @enderror
        </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-10 mb-1">
            <input type="number" class="form-control " required
                   placeholder="روز" id="input3" wire:model="taskDeadline">
            @error('taskDeadline')
            <x-error-form :message="$message"/>
            @enderror
        </div>
        @if($user->admin==1)
            ...
            <div class="col-10">
                <select class="form-control" id="Select1" wire:model="operator_">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
                    <textarea placeholder="توسط خود فرد" class="form-control" id="input4" rows="3"
                              wire:model="resultSelf"></textarea>
            @error('resultSelf')
            <x-error-form :message="$message"/>
            @enderror
        </div>
