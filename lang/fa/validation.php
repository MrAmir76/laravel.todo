...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'otp_code' => 'کد یکبارمصرف',
        'new-password' => 'رمزعبور جدید',
        'taskTitle' => 'عنوان وظیفه',
        'taskBody' => 'شرح مسئولیت',
        'taskDeadline' => 'مهلت انجام',
        'operator_' => 'انجام دهنده',
        'resultSelf' => 'نتیجه کار',
        'contentComment' => 'متن نظر',
        'todo-title' => 'عنوان مسئولیت',
        'todo-body' => 'شرح مسئولیت',
        'todo-deadline' => 'مهلت انجام',
        'finally-result' => 'شرح نتیجه نهایی',
        'status-finally' => 'وضعیت نهایی',
        'inputSearch' => 'متن جستوجو',
        'scopeSearch' => 'حوزه جستوجو',
        'isAdmin' => 'مدیر است',
        'verifyAccount' => 'تایید حساب',
        'content_comment' => 'محتوای نظر',
        "todo_id" => "شناسه مسئولیت",
        "user_id" => 'شناسه کاربر',
    ],
];
