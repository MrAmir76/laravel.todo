...
Route::prefix($version . $prefix)->middleware('guest:sanctum')
    ->group(function () {
...
Route::prefix($version . $prefix)->middleware(['unverified', 'auth:sanctum'])
    ->group(function () {
...
Route::prefix($version . $prefix)->middleware(['verified', 'auth:sanctum'])
    ->group(function () {
